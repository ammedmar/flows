...
The vector field flow we define on cubulated manifolds in Section~\ref{S: logistic} can be viewed as a smooth extension of the cubical poset structure. 
